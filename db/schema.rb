...
ActiveRecord::Schema.define(version: 2021_08_20_115444) do
  ...
  create_table "transactions", force: :cascade do |t|
    ...
    t.string "trans_from_type"
    t.bigint "trans_from_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "user_id"
    t.index ["trans_from_type", "trans_from_id"], name: "index_transactions_on_trans_from"
  ...
  create_table "wallets", force: :cascade do |t|
    ...
    t.string "name", default: "Wallet", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "user_id"
